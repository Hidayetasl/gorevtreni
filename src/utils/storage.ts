...
export const INITIAL_SHOP: ShopItem[] = [
  // Tracks (1-2 Coins)
  { id: 'track-straight', name: 'Düz Ray Parçası', category: 'tracks', price: 5, icon: '🛤️', description: 'Tren yolunu uzatmak için düz ray (2 Görev)', unlocked: true, type: 'track', trackType: 'straight' },
  { id: 'track-curve', name: 'Viraj Ray Parçası', category: 'tracks', price: 5, icon: '↩️', description: 'Trenin dönmesini sağlayan kavisli ray (2 Görev)', unlocked: true, type: 'track', trackType: 'curve' },
  { id: 'track-bridge', name: 'Kırmızı Tren Köprüsü', category: 'tracks', price: 24, icon: '🌉', description: 'Nehrin üstünden geçen yüksek kırmızı köprü', unlocked: false, type: 'track', trackType: 'bridge' },
  { id: 'track-station', name: 'Merkez Tren Garı', category: 'tracks', price: 36, icon: '🚉', description: 'Yolcuların bindiği büyük gar istasyonu', unlocked: false, type: 'track', trackType: 'station' },
  { id: 'track-tunnel', name: 'Dağ Tüneli', category: 'tracks', price: 30, icon: '🕳️', description: 'Trenin içinden geçtiği gizemli tünel', unlocked: false, type: 'track', trackType: 'tunnel' },
  ...
  { id: 'train-blue', name: 'Mavi Süper Hızlı Tren', category: 'trains', price: 36, icon: '🏎️', description: 'Raylarda şimşek gibi süzülen mavi ekspres (~1-2 gün)', unlocked: false, type: 'train' },
  { id: 'train-gold', name: 'Altın Gar Ekspresi', category: 'trains', price: 60, icon: '🌟', description: 'Parlayan altın kaplama özel çocuk treni (~2-3 günlük görevler)', unlocked: false, type: 'train' },
  { id: 'train-rainbow', name: 'Gökkuşağı Treni', category: 'trains', price: 84, icon: '🌈', description: 'Rengarenk ışık saçan neşeli lokomotif', unlocked: false, type: 'train' },
  ...
  { id: 'scenery-flower', name: 'Neşeli Ayçiçeği', category: 'scenery', price: 5, icon: '🌻', description: 'Güneşe bakan renkli büyük çiçek', unlocked: true, type: 'decoration' },
  { id: 'scenery-cow', name: 'Çiftlik İneği', category: 'scenery', price: 10, icon: '🐄', description: 'Möö diyen sevimli çiftlik arkadaşı', unlocked: false, type: 'decoration' },
  { id: 'scenery-house', name: 'Kırmızı Çatı Evi', category: 'scenery', price: 15, icon: '🏠', description: 'İstasyon kasabasının tatlı evi', unlocked: true, type: 'decoration' },
  { id: 'scenery-traffic-light', name: 'Trafik Işığı', category: 'scenery', price: 10, icon: '🚦', description: 'Kasaba yollarına düzen getiren renkli trafik ışığı', unlocked: false, type: 'decoration' },
  { id: 'scenery-park', name: 'Kasaba Parkı', category: 'scenery', price: 15, icon: '🛝', description: 'Çocukların oynadığı küçük yeşil park alanı', unlocked: false, type: 'decoration' },
  { id: 'scenery-windmill', name: 'Rüzgar Gülü', category: 'scenery', price: 15, icon: '🌬️', description: 'Tepede dönen neşeli rüzgar gülü', unlocked: false, type: 'decoration' },
  { id: 'scenery-market', name: 'Kasaba Marketi', category: 'scenery', price: 20, icon: '🏪', description: 'Sincap Köyü için küçük mahalle marketi', unlocked: false, type: 'decoration' },
  { id: 'scenery-school', name: 'Okul', category: 'scenery', price: 20, icon: '🏫', description: 'Öğrenme ve oyun dolu sevimli kasaba okulu', unlocked: false, type: 'decoration' },
  ...
  { id: 'reward-cartoon', name: '30 Dk Ekstra Çizgi Film', category: 'rewards', price: 30, icon: '🎬', description: 'İstediğin çizgi filmi 30 dakika izleme hakkı ⭐ (1 Günlük Başarı)', unlocked: false, type: 'real_reward' },
  { id: 'reward-park', name: 'Parkta Ekstra Oyun', category: 'rewards', price: 36, icon: '🛝', description: 'Çocuk parkında doyasıya kaydırak ve salıncak keyfi ⭐ (1 Günlük Başarı)', unlocked: false, type: 'real_reward' },
  { id: 'reward-toy', name: 'Sürpriz Küçük Oyuncak', category: 'rewards', price: 66, icon: '🎁', description: 'Marketten seveceğin harika bir sürpriz oyuncak! 🌟🌟 (2 Günlük Tam Başarı)', unlocked: false, type: 'real_reward' },
  { id: 'reward-pizza', name: 'Pizza & Sinema Gecesi', category: 'rewards', price: 96, icon: '🍕', description: 'Ailenle birlikte pizza yeme ve sinema gecesi! 🏆 (3 Günlük Dev Başarı)', unlocked: false, type: 'real_reward' },
];
