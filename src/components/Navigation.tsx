...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t-4 border-sky-400 px-3 py-2 shadow-2xl">
      <div className="max-w-xl mx-auto flex items-end justify-around relative">
        ...
        >
          ...
          <span className="text-[11px] font-game uppercase tracking-wide mt-1">
            Görevler
          </span>
        </button>
        ...
        <div className="relative -top-5">
          <button
            ...
            className={`w-16 h-16 sm:w-18 sm:h-18 rounded-full border-4 border-white shadow-xl flex flex-col items-center justify-center text-white transition-all duration-200 active:scale-90 ${
              activeTab === 'shop'
          ...
          >
            <ShoppingBag className="w-7 h-7 drop-shadow-sm" />
            <span className="text-[9px] font-game uppercase tracking-tighter">
              Mağaza
            </span>
          </button>
        </div>
